...
public class SoundMGR : MonoBehaviour
{
    ...
    {
        return instance._PlayBgm(key, volume);
    }
    ...
    {
        return instance._PlaySe(key, volume, channel);
    }
    ...
    public static SoundMGR instance
    {
        get
        {
            if (_instance == null)
            {
                var previous = FindObjectOfType(typeof(SoundMGR));
                if (previous)
                {
                    _instance = (SoundMGR)previous;
                }
                else
                {
                    var go = new GameObject("SoundMGR");
                    _instance = go.AddComponent<SoundMGR>();
